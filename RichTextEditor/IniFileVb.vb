...
Public Class IniFile
    ...
    Public Function Load(ByVal sFileName As String, Optional ByVal bMerge As Boolean = False) As Boolean
        If Not bMerge Then
            RemoveAllSections()
        End If
        '  Clear the object... 
        ...
        'Load ini file in streamreader check if file found
        Dim oReader As StreamReader
        Try
            oReader = New StreamReader(sFileName)
